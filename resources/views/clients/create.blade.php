                    ...
                    <div class="row row-sm">
                        <div class="col-6">
                            <div class="form-group mg-b-0">
                                <label class="form-label">إسم العميل : <span class="tx-danger">*</span></label>
                                <input class="form-control" name="name" placeholder="أدخل إسم العميل" value="{{old('name')}}"   required="" type="text">
                            </div>
                            @error('name')
                                <div class="alert alert-danger">cleint name is importent</div>
                            @enderror
                        </div>
                        <div class="col-6">
                            <div class="form-group mg-b-0">
