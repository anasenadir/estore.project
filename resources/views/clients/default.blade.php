								...
								<div class="d-flex justify-content-end">
                                    ...
                                    <div class="col-sm-6 col-md-3 mg-t-10 mg-sm-t-0">
                                        <button class="btn btn-secondary btn-block">
                                            <a class="text-decoration-none text-light" href="{{route('clients.create')}}">إضافة عميل جديد</a>
                                        </button>
                                    </div>
								</div>
							</div>
							<div class="card-body">
								<div class="table-responsive">
									<table class="table text-md-nowrap" id="example1">
										<thead>
											<tr>
												<th class="wd-15p border-bottom-0">إسم العميل</th>
                                                        ...
                                                        <td class="text-center">
                                                            <div class="btn-group dropend">
                                                                ...
                                                                <ul class="dropdown-menu my-drop-down">
                                                                    <!-- Dropdown menu links -->
                                                                    <li><a href="{{route('clients.edit' , $client->id)}}"><i class="bi bi-eye-fill"></i>تعديل العميل</a></li>
                                                                    <li>
                                                                        <form action="{{route('clients.destroy' , $client->id)}}" method="POST">
                                                                            @csrf
                                                                            @method('DELETE')
                                                                            <button type="submit"  onclick="return confirm('هل تريد حذف هذا العميل')">
                                                                                <i class="bi bi-eye-fill"></i>حذف العميل
                                                                            </button>
                                                                        </form>
                                                                    </li>
                                                                </ul>
