                    ...
                    <div class="row row-sm">
                        <div class="col-3">
                            <div class="form-group mg-b-0">
                                ...
                                <input class="form-control" name="product_name" placeholder="أدخل إسم المنتج" value="{{old('product_name')}}"   required="" type="text">
                            </div>
                            @error('product_name')
                        ...
                        <div class="col-3">
                            <div class="form-group mg-b-0">
                                ...
                                <input class="form-control" name="product_quantity" placeholder="أدخل كمية المنتج" required="" value="{{old('product_quantity')}}" min='0' type="number">
                            </div>
                                    ...
                                    <select class="form-control select2" data-parsley-class-handler="#slWrapper" name='category' value="{{old('category')}} data-parsley-errors-container="#slErrorContainer" data-placeholder="chosse one" required="">
                                        ...
                                        @if (isset($productCategories))
                                            @foreach ($productCategories as $productCategory)
                                                <option value="{{$productCategory->id}}" @if (old('category') == $productCategory->id)
                                                        selected
                                                    @endif>
                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="form-group mg-b-0">
                                ...
                                <input class="form-control" name="buy_price" placeholder="أدخل ثمن الشراء " required="" min='0' type="number" value="{{old('buy_price')}}" step='0.01'>
                            </div>
                            @error('buy_price')
                        ...
                        <div class="col-3 mg-b-0">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="sell_price" placeholder="أدخل ثمن البيع" required="" min='0' type="number" value='{{old('sell_price')}}' step='0.01'>
                            </div>
                            @error('sell_price')
                        ...
                        <div class="col-3">
                            <div class="form-group mg-b-0">
                                ...
                                <input class="form-control" name="product_code" placeholder="أدخل رقم المنتج" required="" value='{{old('product_code')}}' type="text">
                            </div>
                            @error('product_code')
                            ...
                            <div class="form-group mg-b-0">
                                ...
                                <div class="parsley-select" id="slWrapper">
                                    <select class="form-control select2" name='product_unit'  data-parsley-class-handler="#slWrapper" data-parsley-errors-container="#slErrorContainer" data-placeholder="chosse one" required="">
                                        ...
                                        <option value="1" @if (old('product_unit') == '1')
                                            selected
                                        @endif>
                                            للمتر 
                                        </option>
                                        <option value="2"@if (old('product_unit') == '2')
                                            selected
                                        @endif>
                                            للوحدة
                                        </option>
