                                ...
                                @if (isset($paidDetails))
                                    @foreach ($paidDetails as $paidDetail)
                                        <tr>
                                            ...
                                            <td>{{$paidDetail->purchase->invoice_code}}</td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <div class="btn-group dropend">
                                                    ...
                                                    <ul class="dropdown-menu my-drop-down">
                                                        <!-- Dropdown menu links -->
                                                        <li><a href="{{route('purchasesrecipets.edit' , $paidDetail->id)}}"><i class="bi bi-eye-fill"></i>تعديل الفاتورة</a></li>
                                                        <li>
                                                            <form action="{{route('purchasesrecipets.destroy' , $paidDetail->id)}}" method="POST">
                                                                @csrf
                                                                @method('DELETE')
