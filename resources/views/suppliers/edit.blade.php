...
<!-- row opened -->
    <form action='{{route('suppliers.update' , $supplier->id)}}' method='POST' class="row">
        @csrf
        @method('PUT')
                    ...
                    <div class="row row-sm">
                        <div class="col-6">
                            <div class="form-group mg-b-0">
                                ...
                                <input class="form-control" name="name" placeholder="أدخل إسم المورد" value="{{$supplier->name}}"   required="" type="text">
                            </div>
                            @error('name')
                        ...
                        <div class="col-6">
                            <div class="form-group mg-b-0">
                                ...
                                <input class="form-control" name="email" placeholder="أدخل البريد الإلكروني" required="" value="{{$supplier->email}}"  type="email">
                            </div>
                            @error('email')
                    ...
                    <div class="row mt-2">
                        <div class="col-6">
                            <div class="form-group mg-b-0">
                                ...
                                <input class="form-control" name="phone_number" placeholder="أدخل رقم الهاتف " required=""  type="tel" value="{{$supplier->phone_number}}" step='0.01'>
                            </div>
                            @error('phone_number')
                        ...
                        <div class="col-6 mg-b-0">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="address" placeholder="أدخل العنوان" required=""  type="text" value='{{$supplier->address}}'>
                            </div>
                            @error('sell_price')
